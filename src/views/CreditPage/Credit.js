...
const Credit = () => {
  ...
  return (
    <>
      <NavBar />
      <Grid container spacing={3} justify="center" className="credit-container">
        <HeroSection />
        <Grid
          container
          item
        ...
        <Grid item md={10} xs={12} className="tab-container">
          ...
          >
            <Box display="flex" alignItems="center" gridGap="10px">
              <div
                className={
                  activeTab === 'interest' ? 'tab-item active' : 'tab-item'
                }
              ...
              <div
                className={
                  activeTab === 'area' ? 'tab-item active' : 'tab-item'
                }
        ...
        <Grid item md={10} xs={12}>
          ...
          >
            ...
            <Typography variant="caption">monatliche Rate</Typography>
            <Typography variant="caption">effektiver Jaherzins</Typography>
          </Box>
